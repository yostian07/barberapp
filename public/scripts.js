document.addEventListener('DOMContentLoaded', async () => {
  ...
  const apiUrl = 'https://barber-app.azurewebsites.net/api/clients/me';
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.error('Failed to fetch client data:', errorData);
...
document.getElementById('appointment-form')?.addEventListener('submit', async (event) => {
  ...
  const apiUrl = 'https://barber-app.azurewebsites.net/api/appointments';
